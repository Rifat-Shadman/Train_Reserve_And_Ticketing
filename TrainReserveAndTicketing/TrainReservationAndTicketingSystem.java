    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
						System.out.println("** 1.)Rajshahi   | BDT 275 |   "+available[1]+"   **");
    					System.out.println("** 2.)Dinajpur  | BDT 370 |   "+available[2]+"   **");
    					System.out.println("** 3.)Khulna   | BDT 450 |   "+available[3]+"   **");
    					System.out.println("** 4.)Natore       | BDT 200 |   "+available[4]+"   **");
    					System.out.println("** 5.)Rangpur      | BDT 410 |   "+available[5]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					for(x=1; x==1;){
							...
							//if Passenger's Name already used, display error and go back to Input//
    						for(int l=0; l<z; l++){
    					...
    					for(x=1; x==1;){
    						...
    						//for invalid input, display error and go back to Input dashboard//
    						if(to<1 || to>5){
    					...
    					String dest[] = { " ", "Rajshahi", "Dinajpur", "Khulna", "Natore", "Rangpur"};
    					double fare[] = { 0,275,370,450,200,410};
    					...
    					if(print==1){
							...
							System.out.println("FARE PRICE:BDT " + ((ticketD[z][0] * ticketI[z][0]) - (50 * ticketI[z][1] )));
						...
						for(x=1; x==1;){
								...
								for(int b=0;b<z;b++){
									if(search.equalsIgnoreCase(ticketS[b][0])){
	    								...
	    								System.out.println("FARE PRICE: BDT " + ((ticketD[b][0] * ticketI[b][0]) - (50 * ticketI[b][1] )));
